# 1. Modelo de Qualidade e Escopo
...
# 2. Introdução e Seleção de Características
...
# 3. Diagrama e Justificativa de Priorização
...
# 6. Classificação de Subcaracterísticas (Escala 1 a 5)
...
# 7. Matriz de Priorização (Ponderada)
